...
import imgg from '../Images/youcef_kessas_2.jpg'

const ImageBlob = () => {
    return (
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" width="30%"
            id="blobSvg" style={{opacity: 1}}>
            <image x="0" y="0" width="auto" height="100%" clip-path="url(#shape)"
                href={imgg}
            ...
            <defs>
                <linearGradient id="gradient" x1="0%" y1="0%" x2="0%" y2="100%">
                    ...
                    <stop offset="100%" style={{stoColor:' #FFFFFF'}}></stop>
                </linearGradient>
            </defs>
            <clipPath id="shape">
